(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("p2"), require("regexp-events"));
	else if(typeof define === 'function' && define.amd)
		define(["p2", "regexp-events"], factory);
	else if(typeof exports === 'object')
		exports["lazerGameCore"] = factory(require("p2"), require("regexp-events"));
	else
		root["lazerGameCore"] = factory(root["p2"], root["RegExpEvents"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE_p2__, __WEBPACK_EXTERNAL_MODULE_regexp_events__) {
...
exports.DefaultBullet = undefined;
...
var _regexpEvents = __webpack_require__(/*! regexp-events */ "regexp-events");

var _p = __webpack_require__(/*! p2 */ "p2");
...
var Bullet = function (_Emitter) {
	...
	_createClass(Bullet, [{
		...
		value: function emit(event) {
			...
			var v = (_Emitter$prototype$em = _regexpEvents.Emitter.prototype.emit).call.apply(_Emitter$prototype$em, [this, event].concat(args));
...
var DefaultBullet = exports.DefaultBullet = function (_Bullet) {
	...
	function DefaultBullet() {
		...
		return _possibleConstructorReturn(this, (DefaultBullet.__proto__ || Object.getPrototypeOf(DefaultBullet)).apply(this, arguments));
	}

	_createClass(DefaultBullet, [{
		key: "init",
		value: function init() {
			_get(DefaultBullet.prototype.__proto__ || Object.getPrototypeOf(DefaultBullet.prototype), "init", this).call(this);
		...
		value: function calcPath(world) {
			...
			var path = [],
			    currentLength = 0;
			var ray = this.calcPath.ray = this.calcPath.ray || new _p2.default.Ray({
				mode: _p2.default.Ray.CLOSEST,
				collisionGroup: _const.COLLISION_GROUPS.BULLET,
				collisionMask: _const.COLLISION_GROUPS.WALLS
			});
			var result = this.calcPath.result = this.calcPath.result || new _p2.default.RaycastResult();
			var hitPoint = this.calcPath.hitPoint = this.calcPath.hitPoint || _p2.default.vec2.create();
			...
			while (currentLength < opts.maxDistance && hits < opts.maxBounces) {
				if (world.raycast(result, ray)) {
					...
					_p2.default.vec2.copy(ray.from, hitPoint);

					// reflect the direction
					_p2.default.vec2.reflect(ray.direction, ray.direction, result.normal);
   ...
   */
		...
		value: function pointOnPath(path) {
			...
			if (next) {
				...
				pos.x = (0, _utils.lerp)(prev[0], next[0], delta);
				pos.y = (0, _utils.lerp)(prev[1], next[1], delta);
			} else {
				pos.x = prev[0];
				pos.y = prev[1];
			}
...
var _Bullet = __webpack_require__(/*! ./Bullet.js */ "./src/Bullet.js");
...
var BulletManager = function (_Emitter) {
	_inherits(BulletManager, _Emitter);

	function BulletManager(game) {
		_classCallCheck(this, BulletManager);

		var _this = _possibleConstructorReturn(this, (BulletManager.__proto__ || Object.getPrototypeOf(BulletManager)).call(this));
	...
	_createClass(BulletManager, [{
		...
		value: function getBullet(id) {
			if (id instanceof _Bullet2.default) return this.bullets.includes(id) ? id : undefined;else return this.bullets.find(function (bullet) {
				return bullet.id == id;
			});
		}
	}, {
...
BulletManager.BulletTypes = {
	default: _Bullet2.default.DefaultBullet
};
...
var _PlayerManager = __webpack_require__(/*! ./PlayerManager */ "./src/PlayerManager.js");

var _PlayerManager2 = _interopRequireDefault(_PlayerManager);

var _BulletManager = __webpack_require__(/*! ./BulletManager */ "./src/BulletManager.js");

var _BulletManager2 = _interopRequireDefault(_BulletManager);

var _p = __webpack_require__(/*! p2 */ "p2");

var _p2 = _interopRequireDefault(_p);

var _Tilemap = __webpack_require__(/*! ./Tilemap */ "./src/Tilemap.js");

var _Tilemap2 = _interopRequireDefault(_Tilemap);

var _gameConfig = __webpack_require__(/*! ./gameConfig */ "./src/gameConfig.js");
...
var Game = function (_Emitter) {
	...
	function Game(id) {
		...
		_this.config = JSON.parse(JSON.stringify(_gameConfig2.default));

		_this.players = new _PlayerManager2.default(_this);
		_this.map = new _Tilemap2.default(_this);
		_this.bullets = new _BulletManager2.default(_this);

		// create the physics world
		_this.world = new _p2.default.World({
			gravity: [0, 0]
		});
		return _this;
	}
...
var Player = function (_Emitter) {
	...
	function Player(manager, info, props) {
		...
		_this.body.addShape(new _p2.default.Circle({
			radius: 10
		}));

		_this.body.shapes.forEach(function (shape) {
			shape.collisionGroup = _const.COLLISION_GROUPS.PLAYER;
			shape.collisionMask = _const.COLLISION_GROUPS.WALLS | _const.COLLISION_GROUPS.BULLET | _const.COLLISION_GROUPS.PLAYER;
		});
	...
	_createClass(Player, [{
		...
		value: function update(d) {
			...
			if (this.controls.moveX !== 0) this.body.velocity[0] = (0, _utils.lerp)(this.body.velocity[0], speed * Math.sign(this.controls.moveX), excelerate);else this.body.velocity[0] *= decelerate;

			if (this.controls.moveY !== 0) this.body.velocity[1] = (0, _utils.lerp)(this.body.velocity[1], speed * Math.sign(this.controls.moveY), excelerate);else this.body.velocity[1] *= decelerate;

			this.tmp += d;
			if (this.controls.shoot && this.game.isMaster) {
				if (this.tmp > this.cooldown) {
					this.tmp = 0;
					this.game.bullets.createBullet(_BulletManager2.default.BULLET_TYPE.DEFAULT, { owner: this.id }, {
		...
		value: function _updatePosition() {
			this.position.x = (0, _utils.clipDecimals)(this.body.position[0]);
			this.position.y = (0, _utils.clipDecimals)(this.body.position[1]);
			this.position.vx = (0, _utils.clipDecimals)(this.body.velocity[0]);
			this.position.vy = (0, _utils.clipDecimals)(this.body.velocity[1]);
		}
	}, {
		key: "toJSON",
		value: function toJSON() {
...
var PlayerManager = function (_Emitter) {
	_inherits(PlayerManager, _Emitter);

	function PlayerManager(game) {
		_classCallCheck(this, PlayerManager);

		var _this = _possibleConstructorReturn(this, (PlayerManager.__proto__ || Object.getPrototypeOf(PlayerManager)).call(this));
	...
	_createClass(PlayerManager, [{
		...
		value: function getPlayer(id) {
			if (id instanceof _Player2.default) return this.players.includes(id) ? id : undefined;else return this.players.find(function (player) {
				return player.id === id;
			});
		}
	}, {
		...
		value: function createPlayer(info, props) {
			var player = new _Player2.default(this, info, props);
		...
		key: "createFromJSON",
		value: function createFromJSON(json) {
			var player = new _Player2.default(this, json.info, json.props);
...
var Tilemap = function (_Emitter) {
	...
	_createClass(Tilemap, [{
		...
		value: function fromJSON(json) {
			...
			this.bodies.forEach(function (body) {
				body.shapes.forEach(function (shape) {
					shape.collisionGroup = _const.COLLISION_GROUPS.WALLS;
					shape.collisionMask = _const.COLLISION_GROUPS.ALL;
				});
			});
		...
		key: "buildCollisions",
		value: function buildCollisions(collisions) {
			var bodies = [];
			...
			for (var i = 0; i < collisions.length; i++) {
				...
				if (Array.isArray(object.polygon)) {
					var body = new _p2.default.Body({ mass: 0 });
					...
					var _body = new _p2.default.Body({ mass: 0 });
					...
					for (var _i = 1; _i < object.polyline.length; _i++) {
						...
						_body.addShape(new _p2.default.Line({
							position: [(0, _utils.lerp)(prev.x, curr.x, 0.5), (0, _utils.lerp)(prev.y, curr.y, 0.5)],
							length: length,
							angle: angle
						}));
					}
			...
			mapJSON.tiles = mapJSON.tiles.map(function (row) {
				return row.map(function (tile) {
					...
					var type = mapJSON.types.find(function (type) {
						return (0, _isEqual3.default)(tile, type);
					});
...
exports.COLLISION_GROUPS = COLLISION_GROUPS;
...
exports.BulletManager = exports.Bullet = exports.Tilemap = exports.PlayerManager = exports.Player = exports.Game = undefined;
...
exports.PlayerManager = _PlayerManager2.default;
exports.Tilemap = _Tilemap2.default;
exports.Bullet = _Bullet2.default;
exports.BulletManager = _BulletManager2.default;
...
exports.NAMES = exports.NAME_TEMPLATES = undefined;
exports.createName = createName;
exports.lerp = lerp;
exports.parseSearch = parseSearch;
exports.getURLSearchSettings = getURLSearchSettings;
exports.buildCollisions = buildCollisions;
exports.clipDecimals = clipDecimals;
...
var NAME_TEMPLATES = exports.NAME_TEMPLATES = ["nice {{name}}", "awesome {{name}}", "{{name}} the cool", "{{name}} the short", "{{name}} the tall", "{{name}} the fat", "{{name}} the thin", "{{name}} the scared", "insane {{name}}", "{{name}} the kid", "really fat {{name}}", "{{name}} the smart", "{{name}} the brave", "the amazing {{name}}", "{{name}} the bald"];
var NAMES = exports.NAMES = ["James", "John", "Robert", "Michael", "William", "David", "Richard", "Charles", "Joseph", "Thomas", "Christopher", "Daniel", "Paul", "Mark", "Donald", "George", "Kenneth", "Steven", "Edward", "Brian", "Ronald", "Anthony", "Kevin", "Jason", "Matthew", "Gary", "Timothy", "Jose", "Larry", "Jeffrey", "Frank", "Scott", "Eric", "Stephen", "Andrew", "Raymond", "Gregory", "Joshua", "Jerry", "Dennis", "Walter", "Patrick", "Peter", "Harold", "Douglas", "Henry", "Carl", "Arthur", "Ryan", "Roger", "Joe", "Juan", "Jack", "Albert", "Jonathan", "Justin", "Terry", "Gerald", "Keith", "Samuel", "Willie", "Ralph", "Lawrence", "Nicholas", "Roy", "Benjamin", "Bruce", "Brandon", "Adam", "Harry", "Fred", "Wayne", "Billy", "Steve", "Louis", "Jeremy", "Aaron", "Randy", "Howard", "Eugene", "Carlos", "Russell", "Bobby", "Victor", "Martin", "Ernest", "Phillip", "Todd", "Jesse", "Craig", "Alan", "Shawn", "Clarence", "Sean", "Philip", "Chris", "Johnny", "Earl", "Jimmy", "Antonio"];

function createName() {
	return NAME_TEMPLATES[Math.floor(Math.random() * NAME_TEMPLATES.length)].replace("{{name}}", NAMES[Math.floor(Math.random() * NAMES.length)]);
}
...
function parseSearch(url) {
	...
	if (!parseSearch.cache[url]) {
		...
		for (var i = 0; i < queries.length; i++) {
			...
			if (split[0] !== "") {
				var value = split[1];
				if (!isNaN(value)) value = parseFloat(value);else if (value === "true" || value === undefined || value === "on") value = true;else if (value === "false" || value === "off") value = false;else value = window.unescape(value);
...
function getURLSearchSettings() {
	...
	if (!getURLSearchSettings.cache[url]) {
		var params = parseSearch(url);
		var settings = (0, _clone3.default)(DEFAULT_SETTINGS);
...
function buildCollisions(collisions) {
	var bodies = [];
...
/***/ "p2":
/*!**************************************************************************!*\
  !*** external {"commonjs":"p2","commonjs2":"p2","amd":"p2","root":"p2"} ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __WEBPACK_EXTERNAL_MODULE_p2__;

/***/ }),

/***/ "regexp-events":
/*!*********************************************************************************************************************!*\
  !*** external {"commonjs":"regexp-events","commonjs2":"regexp-events","amd":"regexp-events","root":"RegExpEvents"} ***!
  \*********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __WEBPACK_EXTERNAL_MODULE_regexp_events__;
